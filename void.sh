...
### NOTE: If you want to git my build of the suckless tools comment the three lines before and uncomment the following line.

#git clone https://github.com/elbachir-one/MySuckless
cd
touch ~/.xinitrc
